...
python train.py "$@" --gpt_config configs/gpt/long_ctx.yaml --optimizer_config configs/optimizer/base.yaml --train_config configs/train/cfg3b.yaml --loss_weighting unweighted --run_name cf3g3b_unweighted