...
python train.py --gpt_config configs/gpt/short_ctx.yaml --optimizer_config configs/optimizer/small_lr.yaml --train_config configs/train/base_txt.yaml --loss_weighting unweighted --run_name llama_wiki_mini_short_2p5en4_LR
